...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-palette1-200 text-primary-500 text-center rounded p-2 flex-shrink-0`}
  ${props => [
    props.iconRoundedFull && tw`rounded-full`,
    props.iconFilled && tw`border-0 bg-palette1-200 text-white`
  ]}
  svg {
    ${tw`w-5 h-5`}
  }
...
const PrimaryButton = styled(PrimaryButtonBase)(props => [
  tw`font-semibold mt-12 text-sm inline-block mx-auto md:mx-0`,
