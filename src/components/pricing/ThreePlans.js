...
const Plan = styled.div`
  ${tw`w-full max-w-sm mt-16 lg:mx-4 lg:last:mr-0 text-center px-8 rounded-lg shadow relative pt-2 text-gray-900 bg-white flex flex-col`}
  .planHighlight {
  ...
  ${props =>
    ...
    css`
      ...
      ${BuyNowButton} {
        ${tw`bg-palette1-100 text-white hocus:bg-palette1-200 hocus:text-black`}
    `}
`;
...
const BuyNowButton = styled(PrimaryButtonBase)`
  ${tw`rounded-2xl uppercase border-0 tracking-wider py-4 w-full text-sm hover:shadow-xl transform hocus:translate-x-px hocus:-translate-y-px focus:shadow-outline`}
`;
