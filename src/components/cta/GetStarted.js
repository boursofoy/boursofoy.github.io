...
const PrimaryBackgroundContainer = tw.div`py-20 lg:py-24 bg-palette1-200 rounded-2xl relative`
...
const DecoratorBlob2 = tw(SvgDecoratorBlob1)`absolute top-0 right-0 w-80 h-80 transform  translate-x-20 -translate-y-64 text-palette1-100 opacity-50`
export default ({
